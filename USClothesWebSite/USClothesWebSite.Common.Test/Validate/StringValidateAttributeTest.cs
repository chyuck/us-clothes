...
{
    [TestClass]
    public class StringValidateAttributeTest
    {
        [TestMethod]
        public void Test_Constructor_Should_Set_Default_Values()
        {
            // Act
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_False_When_Value_Is_Less_Than_MinLength()
        {
            // Arrange
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_False_When_Value_Is_Greater_Than_MaxLength()
        {
            // Arrange
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_False_When_Value_Is_Null_And_CanBeNull_Is_False()
        {
            // Arrange
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_False_When_Value_Is_Empty_And_CanBeEmpty_Is_False()
        {
            // Arrange
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_False_When_Value_Is_Not_Match_Regex()
        {
            // Arrange
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_True_When_Parameters_Not_Specified()
        {
            var values =
                new[]
                {
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_True_When_Value_Meet_All_Requirements()
        {
            // Arrange
            var attr = new StringValidateAttribute("Test message")
                           {
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_True_When_Value_Is_Empty_And_Not_Meet_All_Requirements_Except_CanBeEmpty()
        {
            // Arrange
            var attr = new StringValidateAttribute("Test message")
            {
        ...
        [TestMethod]
        public void Test_IsValid_Should_Return_True_When_Value_Is_Null_And_Not_Meet_All_Requirements_Except_CanBeNull()
        {
            // Arrange
            var attr = new StringValidateAttribute("Test message")
            {
